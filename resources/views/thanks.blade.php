...
<head>
    ...
    <style>
        ...
        .gallery img { width: 100%; max-width: 100%; height: auto; border-radius: 4px; margin-bottom: 10px; }
...
<body>
    ...
    <div class="container">
        ...
        <!-- Content -->
        <div class="content">
            <h2 style="font-size: 20px; color: #333333; text-align: center;">Thank You {{$new_book->firstname}}  for Your Booking!</h2>
            <p style="font-size: 16px; color: #555555; text-align: center;">Thank you {{$new_book->firstname}} for choosing us for your stay. At Lipilima Tower, we are committed to providing you with an exceptional experience. From our comfortable, well-appointed rooms to our attentive service, we aim to make your visit memorable and enjoyable. Your Booking ID is {{$new_book->booking_id}}</p>
        ...
        <!-- Footer -->
        <div class="footer">
            <p>Thank you for considering our apartment. We look forward to welcoming you!</p>
            <p>If you have any questions, feel free to contact us :<a href="tel:0778777725" style="color: #3b82f6; text-decoration: none;"> 0778777725</a>.</p>
        </div>
    </div>
