...
<div class=" flex items-center justify-center min-h-screen pt-36">
   ...
   /*
    ...
    <div class="flex-1">
        ...
        <select id="number_of_guest" name="number_of_guest" class="w-full border border-gray-300 rounded-lg p-2" required>
            <option value="" selected disabled>Select a Number of Guests</option>http://127.0.0.1:8000/step2_book
            <option value="1">1</option>
            <option value="2">2</option>
        </select>
    </div>
 ...
 /*
            ...
            <div class="mb-4">
               ...
               <!-- Total Amount -->
               <div class="mb-4">
                <label for="total_amount" class="block text-lg font-medium mb-2">Total Amont:</label>
                <input type="text" id="total_amount" name="total_amount" class="w-full border border-gray-300 rounded-lg p-5"  readonly>
            </div>
*/ ?>
